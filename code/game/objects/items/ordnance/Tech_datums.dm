...
/datum/ordnance_tech/technology/T1_ammo
	name = "T1 Ammunition Upgrade"
	desc = "Allows the creation of custom T1 ammunition."
	name = "Ammunition Upgrade"
	desc = "Allows the creation of custom ammunition."
	tech_unlock = list(CUSTOM_RIFLE_HOLO_AMMO, CUSTOM_SMG_HOLO_AMMO)
	value = 50
	add_category = FALSE

/datum/ordnance_tech/technology/T2_ammo
	name = "T2 Ammunition Upgrade"
	desc = "Allows the creation of custom ammunition."
	tech_unlock = list(CUSTOM_RIFLE_AP_AMMO, CUSTOM_RIFLE_LE_AMMO, CUSTOM_SMG_AP_AMMO, CUSTOM_SMG_LE_AMMO)
	value = 75
	add_category = FALSE

/datum/ordnance_tech/technology/T3_ammo
	name = "T3 Ammunition Upgrade"
	desc = "Allows the creation of custom T3 ammunition."
	tech_unlock = list(CUSTOM_RIFLE_EXPLOSIVE_AMMO, CUSTOM_SMG_EXPLOSIVE_AMMO)
	value = 150
	add_category = FALSE
