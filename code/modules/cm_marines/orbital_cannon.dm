...
/obj/structure/ob_ammo/warhead/custom
	...
	var/clear_falloff = 400
	var/clear_delay = 3
	var/double_explosion_delay = 3 SECONDS // has to be over 3 seconds due to chemistry reagent bullshit

	var/list/reaction_limits = list( "max_ex_power" = 1200, "base_ex_falloff" = 550, "max_ex_shards" = 250, //not sure why you would want to add shards to this but whatever
